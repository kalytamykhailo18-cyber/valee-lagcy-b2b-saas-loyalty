...
function ConsumerApp() {
    ...
    async function handleRequestOTP() {
        ...
        if (!digits.startsWith('58') || digits.length !== 12) {
            setError('Ingresa un número venezolano valido (10 digitos)')
            return
        }
        setLoading(true)
        try {
        ...
        return (
            <div className="min-h-screen flex flex-col items-center justify-center">
                ...
                <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-12">
                    ...
                    {/* Right Side: The Form (Always visible) */}
                    <div className="lg:col-span-4 flex flex-col items-center justify-center p-8 bg-white">

                        <div className="w-full max-w-sm space-y-6">

                            <div className="text-center aa-rise pb-[50px]">

                                <h1 className="text-4xl font-extrabold tracking-tight text-black transition-colors">Comienza a ganar puntos con <span className="text-indigo-700">Valee!</span></h1>
                                <p className="text-slate-500 mt-2">Ingresa tu número para comenzar...</p>

                            </div>

                            <div className="space-y-2 aa-rise">
                                {(() => {
                                    ...
                                    return (
                                        <>
                                            <div className={`rounded-xl border overflow-hidden ${showValidation && !isValid
                                            ...
                                            {showValidation && normalized.length >= 3 && !validPrefix && (
                                                <p className="text-amber-600 text-xs">El número debe empezar con 414, 424, 412, 416 o 426</p>
                                            )}
                                            ...
                                            >
                                                {loading && <span className="aa-spinner" />}<span className="relative z-10">{loading ? 'Enviando...' : 'Enviar código OTP'}</span>
                                            </button>
                                            <p className="text-xs text-slate-400 text-center pt-2">
                                                Recibiras un código por WhatsApp para verificar tu número.
                                            </p>
                                        </>
                                    )
                                })()}
                    ...
                    {/* Left Side: Image (Hidden on phone, visible on lg screens) */}
                    <div className="hidden lg:flex lg:col-span-8 flex-col items-center justify-center relative bg-indigo-200">
                        <div className="max-w-md text-center">
                            ...
                            />
                            <h2 className="text-3xl font-extrabold text-[#31438a]">
                                Simplifica tus recompensas
                            </h2>
                            <p className="text-[#31438a] mt-4">
                                Gestiona tus puntos y ahorros en un solo lugar.
                            </p>
                        </div>
                    </div>
                ...
                <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-12">
                    ...
                    <div className="lg:col-span-4 flex flex-col items-center justify-center p-8 bg-white">
                        ...
                        <div className="text-center aa-rise pb-[50px]">
                            ...
                            <h1 className="text-4xl font-extrabold tracking-tight text-black transition-colors"><span className="text-indigo-700">Verificación</span></h1>
                            <p className="text-slate-500 mt-2">Ingresa el código de 6 digitos que hemos enviado a tu WhatsApp</p>
                        ...
                        <div className="space-y-4 aa-rise" style={{ animationDelay: '80ms' }}>
                            ...
                            <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 mt-2 text-center">
                                <p className="text-xs text-amber-800 font-medium">No te llego el código?</p>
                                <p className="text-xs text-amber-700 mt-1">
                                    Envia <b>Hola</b> a nuestro WhatsApp y vuelve a pedir el código.
                                </p>
                                <a
    ...
    const greeting = account?.displayName
        ? `¡Qué bueno verte, ${account.displayName.split(/\s+/)[0]}!`
        : '¡Hola!'
    ...
    {/* Consumer content business view */ }
    return (
        <div className="min-h-screen bg-gray-50 pb-32">
                        ...
                        {phoneNumber && (
                            <div className="mt-1 flex items-center gap-2 flex-wrap">
                                <span className="inline-flex items-center gap-1.5 bg-indigo-50 border border-indigo-200 text-indigo-800 text-[11px] sm:text-xs font-mono font-semibold px-2 py-0.5 rounded-full">
                                    {phoneNumber.startsWith('+58') ? `0${phoneNumber.slice(3)}` : phoneNumber}
                                </span>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {account?.merchantName && (
                                <>
                                    ...
                                    <span className="text-xs font-semibold text-slate-600 truncate">{account.merchantName}</span>
                                </>
                            )}
                        </div>
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <section
                    className="aa-rise mx-4 mt-5 bg-indigo-80 rounded-3xl p-6 sm:p-7 text-black overflow-hidden relative border border-indigo-200"
                ...
                >
                    ...
                    {/* Logo + Business name */}
                    <div className="aa-rise-sm flex items-center justify-start gap-3 bg-red mb-5">
                        ...
                        {/* Business name */}
                        <h1 className="text-2xl font-bold text-slate-800 tracking-tight truncate">{account?.merchantName}</h1>
                    ...
                    <div className="relative">
                        ...
                        <div className="flex items-start justify-between gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="text-[10px] uppercase tracking-[0.14em] text-black-100 font-semibold mb-1.5">Tus puntos:</p>
                                <p key={displayBalance} className="text-[56px] sm:text-6xl font-bold tracking-tight tabular-nums leading-none break-all aa-count">
                                    {displayBalance}
                                    <span className="text-black-100 font-semibold text-sm mt-2.5 ml-2">{unitLabel}</span>
                                </p>

                            </div>

                            {account?.levelName && (
                                <div className="flex items-center gap-1.5 bg-indigo-600 backdrop-blur rounded-full px-3 py-1.5 border border-white/20 flex-shrink-0">
                                    <MdStarRate className="w-4 h-4 text-amber-300" />
                                    <span className="text-xs font-bold text-white tracking-tight">{account.levelName}</span>
                                </div>
                            )}
                        </div>
                        ...
                        <button
                            ...
                            className="mt-5 text-xs font-semibold text-black-100 hover:text-gray inline-flex items-center gap-1 transition-colors"
                        >
 ...
 {activeCodesCount > 0 && (
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-amber-900 font-bold text-sm">Tienes {activeCodesCount} código{activeCodesCount > 1 ? 's' : ''} activo{activeCodesCount > 1 ? 's' : ''}</p>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="text-sm font-normal text-slate-500 line-clamp-1 tracking-tight">{p.stock} disponibles</p>
                                            {(() => {
                                                const names = p.branchNames || []
                                                if (p.branchScope === 'branch' && p.branchName) {
                                                    return (
                                                        <p className="text-[11px] text-emerald-700 mt-1 truncate" title={p.branchName}>
                            ...
                            {hybridProducts.map((p: any) => (
                                ...
                                >
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <p className="text-sm text-indigo-600 font-bold mt-0.5 tabular-nums">{formatPoints(p.redemptionCost)} pts <span className="text-sm text-amber-600 font-bold mt-0.5">+ ${formatCash(p.cashPrice)}</span></p>
                                    </div>
                                </Link>
                            ))}
                        </div>
            ...
            <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 p-4 flex gap-3 shadow-lg z-10 aa-rise-sm lg:hidden">
                <div className="flex gap-3 w-full lg:max-w-[60%] lg:mx-auto">
                    <Link
                        href="/scan"
...
function MultiMerchantHub() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 via-white to-white">
            <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
                <div className="max-w-[90%] mx-auto px-3 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between gap-2">
                    <div className="min-w-0">
                        <Link href="/" className="inline-block text-xl sm:text-2xl font-extrabold tracking-tight text-indigo-700 hover:text-indigo-800 transition-colors">Valee</Link>
            ...
            <main className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-10">
                <div className="mb-3 sm:mb-4 lg:mb-6 aa-rise-sm">
                    ...
                    <h1 className="text-xl sm:text-3xl font-bold text-slate-800 tracking-tight">{displayName ? `¡Qué bueno verte, ${displayName.split(/\s+/)[0]}!` : '¡Hola!'}</h1>
                    <p className="text-slate-500 mt-2">Revisa tus puntos y canjea tus beneficios favoritos.</p>
                ...
                <section className="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-2xl sm:rounded-3xl p-4 sm:p-8 lg:p-10 text-white shadow-xl aa-rise overflow-hidden">
                    <p className="text-indigo-200 text-xs sm:text-base">Tienes acumulados:</p>
                    ...
                    {(() => {
                        ...
                        return (
                            <p className="text-indigo-200 text-sm sm:text-base mt-2">
                                Distribuidos en {withBalance} comercio{withBalance !== 1 ? 's' : ''} listo{withBalance !== 1 ? 's' : ''} para canjear.
                            </p>
                        )
                    })()}
                        ...
                        <>
                            {mine.length > 0 && (
                                <section className="mt-8 sm:mt-10 lg:mt-14">
                                    <h2 className="text-slate-900 font-bold text-lg sm:text-xl tracking-tight mb-4 sm:mb-5 px-1">Tus sitios favoritos con Valee</h2>
                                    <div className="space-y-4 sm:space-y-5 md:grid md:grid-cols-2 md:gap-5 md:space-y-0 lg:gap-3">
                                        {mine.map((m, i) => (
                                            <div
                                                key={m.tenantId}
                                                ...
                                                <div className="px-6 pt-6 pb-5 sm:px-7 sm:pt-7 sm:pb-6">
                                                    <div className="flex items-start justify-between gap-4">
                                                        <div className="min-w-0 flex-1">
                                                            ...
                                                            <p className="text-[11px] uppercase tracking-[0.12em] text-slate-400 font-semibold mb-1 mt-5">Tus puntos:</p>
                                                            {(() => {
                                                                ...
                                                                return (
                                                                    <p className={`${cls} font-bold text-slate-900 tracking-tight tabular-nums leading-none`}>
                                                                        {formatPoints(displayBal)} <span className="text-sm text-slate-500 mt-1.5">{m.unitLabel}</span>
                                                                    </p>
                                                                )
                                                            })()}
                                                            ...
                                                            {m.topProducts.map(p => {
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <p className="text-xs text-slate-400">{p.stock} disponibles</p>
