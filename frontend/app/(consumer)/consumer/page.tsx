    ...
    if (screen === 'otp') {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-4">
                ...
                <div className="w-full max-w-sm space-y-6">
                    <div className="text-center aa-rise mb-[100px]">
                        <h1 className="text-2xl font-bold text-indigo-600 tracking-tight mb-[100px]">Verificacion</h1>
                        <p className="text-slate-500 mt-1">Ingresa el código de 6 digitos enviado a tu WhatsApp</p>
                    </div>
